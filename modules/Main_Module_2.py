...
def word_count(ds_type):
    ...
    if ds_type.lower()=='h':
        ...
        if ip2=='1':
            ...
            list_deleted_items=string_deleted_items.split(' ')
            for del_item in list_deleted_items:
                create_rbt.delete_key(create_rbt.root,del_item)
            create_rbt.sort()
        ...
        if ip3=='1':
            ...
            list_keys=string_keys.split(' ')
            for key_item in list_keys:
                print("\n The succesor of key '"+key_item+"' is "+create_rbt.successor_key(create_rbt.search_key(key_item)).key)
        ...
        if ip4=='1':
            ...
            list_of_keys=string_of_keys.split(' ')
            for key_item in list_of_keys:
                print("\nThe predecessor of key '"+key_item+"' is "+create_rbt.predecessor_key(create_rbt.search_key(key_item)).key)
    else:
